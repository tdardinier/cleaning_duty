python3 generate.py html 16 > html/table.html
...
if [ "$(uname)" == "Darwin" ]; then
    ...
    google-chrome --headless --screenshot=cleaning_duty.png  --window-size=2000,1414 --default-background-color=0 cleaning_duty.html
